#!/usr/bin/env python
"""
ETF — Chapter 2: Relative / Cross-Sectional Momentum (XSMOM).

Ranks all eligible ETFs by signal strength, goes long the top-K.
Tests across the multi-asset ETF universe.

Usage:
    python -m scripts.research.jpm_momentum.run_etf_ch2_relative [--start 2006-01-01]
"""
...
from .data import load_etf_daily_bars, ANN_FACTOR_ETF, compute_benchmark
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="ETF Ch2: Relative momentum factor scan")
    p.add_argument("--start", default="2006-01-01")
    p.add_argument("--end", default="2026-12-31")
    p.add_argument("--out-dir", default="output/jpm_momentum_etf/ch2_relative")
...
def main() -> None:
    ...
    print("=== ETF Ch2: Relative Momentum Factor Scan ===")
