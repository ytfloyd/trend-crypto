...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Metrics for Transtrend Crypto MA(5/40) fixed-universe baseline")
...
def main() -> None:
    ...
    print(f"[transtrend_crypto_ma_5_40_fixed_universe_metrics] Wrote metrics to {out_path}")
