...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="kuma_01 tear sheet")
...
def main() -> None:
    ...
    metrics_path = Path(args.metrics_csv) if args.metrics_csv else research_dir / "metrics_kuma_01_v0.csv"
    if not metrics_path.exists():
        print(f"[kuma_01_tearsheet] Metrics CSV not found: {metrics_path}; computing stats from equity.")
